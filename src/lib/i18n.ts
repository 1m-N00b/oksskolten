...
const dict = {
  ...
  'settings.articlePurge': { ja: '記事データのパージ', en: 'Article Purge' },
  'settings.articlePurgeDesc': { ja: '古い既読記事を一括削除してストレージを節約', en: 'Bulk-delete old read articles to save storage' },
